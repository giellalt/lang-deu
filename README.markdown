...
This directory contains source files for the German language morphology
...
The German analyser is just for testing, it is not a functional
analyser.

Documentation can be found here:

-   <https://giellalt.uit.no/lang/deu/index.html> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use German language morphology and dictionaries,
you need:
...
The German language sources can be acquired using [giella SVN
